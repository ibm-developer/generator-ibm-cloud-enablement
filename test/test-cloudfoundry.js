				...
				describe('cloud-enablement:cloudfoundry with ' + language + ' with buildType ' + buildType + ' and createType ' + createType, function () {
					...
					it('manifest.yml is generated with correct content', function () {
						...
						if (language === 'JAVA' || language === 'libertyBeta') {
							...
							assertYmlContent(manifestyml.applications[0].buildpacks[0], 'liberty-for-java', 'manifestyml.applications[0].buildpacks[0]')
						...
						if ( language === 'SPRING' ) {
							...
							assertYmlContent(manifestyml.applications[0].buildpacks[0], 'java_buildpack', 'manifestyml.applications[0].buildpacks[0]')
						}
					});
